<%@ Page Title="" Language="C#" MasterPageFile="~/MaestraRecetario.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
        ...
        <asp:GridView ID="gvRecetas" runat="server" AutoGenerateColumns="False" Style="color: whitesmoke" ShowFooter="True" OnRowCancelingEdit="gvRecetas_RowCancelingEdit" OnRowDeleting="gvRecetas_RowDeleting" OnRowEditing="gvRecetas_RowEditing" OnRowUpdating="gvRecetas_RowUpdating" DataKeyNames="Id, TipoId, DificultadId" AllowSorting="True" OnSorting="gvRecetas_Sorting">
            <Columns>
                ...
                <asp:TemplateField HeaderText="[Video]">
                    ...
                    <ItemTemplate>
                        <%--<iframe id="ifVideoIT" runat="server" type="text/html" src='<%# Bind("Video") %>' ></iframe>--%>
                    </ItemTemplate>
                    <FooterTemplate>
