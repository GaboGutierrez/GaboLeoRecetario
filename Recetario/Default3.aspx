<%@ Page Title="" Language="C#" MasterPageFile="~/MaestraRecetario.master" AutoEventWireup="true" CodeFile="Default3.aspx.cs" Inherits="Default3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="container">
        <label class="label label-primary">Todos los datos</label>
        <asp:GridView ID="gvRecetas" runat="server" AutoGenerateColumns="False" Style="color: whitesmoke" ShowFooter="True" OnRowCancelingEdit="gvRecetas_RowCancelingEdit" OnRowDeleting="gvRecetas_RowDeleting" OnRowEditing="gvRecetas_RowEditing" OnRowUpdating="gvRecetas_RowUpdating" DataKeyNames="Id, TipoId, DificultadId" AllowSorting="True" OnSorting="gvRecetas_Sorting" AllowPaging="True" OnPageIndexChanging="gvRecetas_PageIndexChanging">
            <Columns>
                ...
                <asp:TemplateField HeaderText="[Nombre]" SortExpression="[Nombre]">
                    ...
                    <ItemTemplate>
                        <asp:Label CssClass="form-control table-responsive" Style="height: 150px;" ID="lblNombreIT" runat="server" Text='<%# Bind("Nombre") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                ...
                <asp:TemplateField HeaderText="[Ingredientes]">
                    ...
                    <ItemTemplate>
                        <asp:Label CssClass="form-control table-responsive" Style="height: 150px;" ID="lblIngredientesIT" runat="server" Text='<%# Bind("Ingredientes") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                ...
                <asp:TemplateField HeaderText="[Elaboración]">
                    ...
                    <ItemTemplate>
                        <asp:Label CssClass="form-control table-responsive" Style="height: 150px;" ID="lblElaboracionIT" runat="server" Text='<%# Bind("Descripcion") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
        ...
        <div class="row">
            <div class="col-xs-3">
                <asp:Button ID="btnCincoUltimos" Text="Cargar 5 últimos registrados al recetario" runat="server" CssClass="btn btn-primary" OnClick="btnCincoUltimos_Click" />
            </div>
            <div class="col-xs-3">
                <asp:Button ID="btnOrdenDesc" Text="Ordenar todos de forma descendente" runat="server" CssClass="btn btn-primary" OnClick="btnOrdenDesc_Click" />
            </div>
            <div class="col-xs-3">
                <asp:Button ID="btnOrdenLongitud" Text="Ordenar por la longitud de su nombre" runat="server" CssClass="btn btn-primary" OnClick="btnOrdenLongitud_Click" />
            </div>
            <div class="col-xs-3">
                <asp:Button ID="btnWhere" Text="Buscar huevo en los ingredientes" runat="server" CssClass="btn btn-primary" OnClick="btnWhere_Click" />
            </div>
            <div class="col-xs-3">
                <asp:TextBox ID="txtWhereGrid" runat="server" CssClass="form-control" Placeholder="Texto a buscar:" />
                <asp:Button ID="btnWhereString" Text="Busar texto anterior" runat="server" CssClass="btn btn-primary" OnClick="btnWhereString_Click" />
            </div>
            <div class="col-xs-3">
                <asp:Button ID="btnLambdaSelect" Text="Select con lambda" runat="server" CssClass="btn btn-primary" OnClick="btnLambdaSelect_Click" />
            </div>
            <div class="col-xs-3">
                <asp:Button ID="btnAgruparLINQ" Text="Agrupar dificultad" runat="server" CssClass="btn btn-primary" OnClick="btnAgruparLINQ_Click" />
                <asp:Label ID="lblAgruparLINQDifId" CssClass="form-control" runat="server" Height="100px" />
                <asp:Label ID="lblAgruparLINQDifNombre" CssClass="form-control" runat="server" Height="100px" />
            </div>
            <div class="col-xs-3">
                <asp:Button ID="Button4" Text="" runat="server" CssClass="btn btn-primary" />
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-xs-offset-1 col-xs-10">
                <asp:GridView ID="gvBtnCinco" runat="server" BackColor="#CCCCCC" AutoGenerateColumns="False" CssClass="form-control" DataKeyNames="Id,Nombre,Ingredientes,Descripcion,Tipo,Dificultad,Porciones,Tiempo,FechaAlta">
                    <Columns>
                        <asp:TemplateField HeaderText="[Nombre]">
                            <ItemTemplate>
                                <asp:Label ID="Label1" CssClass="form-control table-responsive" Style="height: 150px;" runat="server" Text='<%# Bind("Nombre") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="[Ingredientes]">
                            <ItemTemplate>
                                <asp:Label ID="Label3" CssClass="form-control table-responsive" Style="height: 150px;" runat="server" Text='<%# Bind("Ingredientes") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="[Elaboración]">
                            <ItemTemplate>
                                <asp:Label ID="Label4" CssClass="form-control table-responsive" Style="height: 150px;" runat="server" Text='<%# Bind("Descripcion") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="[Tipo]">
                            <ItemTemplate>
                                <asp:Label ID="Label5" CssClass="form-control" runat="server" Text='<%# Bind("Tipo") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="[Dificultad]">
                            <ItemTemplate>
                                <asp:Label ID="Label6" CssClass="form-control" runat="server" Text='<%# Bind("Dificultad") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="[Porciones]">
                            <ItemTemplate>
                                <asp:Label ID="Label7" CssClass="form-control" runat="server" Text='<%# Bind("Porciones") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="[Tiempo]">
                            <ItemTemplate>
                                <asp:Label ID="Label8" CssClass="form-control" runat="server" Text='<%# Bind("Tiempo") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="[Fecha de Alta]">
                            <ItemTemplate>
                                <asp:Label ID="Label2" CssClass="form-control" runat="server" Text='<%# Bind("FechaAlta", "{0 : dd/MM/yyyy}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
